...
//  mail transporter that is form which and where host and the user name and app passowrd
...
const transporter = nodemailer.createTransport({
  ...
  secure: true,
  auth: {
    user: "theprabhatrawat370@gmail.com",
    pass: process.env.MAIL_PASSWORD,
  },
});

// mail endpoint why we are not using an api to call because we dont want anyone to access mail by only /mail hence making a funciton from it
